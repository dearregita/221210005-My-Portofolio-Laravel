                    ...
                    <div class="bg-light rounded-4 py-5 px-4 px-md-5">
                        ...
                        <div class="row gx-5 justify-content-center">
                            <div class="col-lg-8 col-xl-6">
                                ...
                                <form id="contactForm" action="{{ route('contactus.store') }}" method="POST" data-sb-form-api-token="API_TOKEN">
                                    {{ csrf_field() }}
                                    ...
                                    <!-- Submit Button-->
                                    <div class="d-grid"><button class="btn btn-primary btn-lg" id="submitButton" type="submit">Send</button></div>
                                </form>
                            </div>
                        </div>
                    </div>
